...
ARG VUE_APP_USERGUIDING_USER
ARG VUE_APP_USERGUIDING_WELCOME
...
ENV VUE_APP_USERGUIDING_USER "${VUE_APP_USERGUIDING_USER}"
ENV VUE_APP_USERGUIDING_WELCOME "${VUE_APP_USERGUIDING_WELCOME}"
